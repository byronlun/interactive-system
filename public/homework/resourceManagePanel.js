...
//			}
			...
			myDynamicMapServiceLayer.setUrl("http://10.21.23.130:6080/arcgis/rest/services/hainan/haiNan/MapServer");
...
//			myDynamicMapServiceLayer.setUrl("http://10.110.110.51:6080/arcgis/rest/services/haiNan/haiNan/MapServer");
			...
			*/
			var tiledMapServiceLayer = new esri.layers.ArcGISTiledMapServiceLayer("http://10.21.23.130:6080/arcgis/rest/services/hainan/haiNanTile/MapServer");
			map.addLayer(tiledMapServiceLayer);
			
			// 地图加载时的蒙版(使用切片地图换，速度很快，没必要再用蒙版)
			var layersLoaded = 0;
